...
const stripePromise = loadStripe('pk_test_51PYU7Y2M9yZW1RSR6GPGuUGewzPNNgjX73akl547aHdBJkqa2posjaxWunhJ33OkccgEHBGYKCgXYpwUWQTyk3HO00eR1kLWsR');
  ...
  return (
    <div className='p-4 mt-16 max-w-[1400px] mx-auto'>
        ...
        <div className='text-center mt-8'>
            ...
            <button onClick={handleCheckout} className='btn bg-error'>Proceed to Checkout</button>
        </div>  
    </div>
  )
}
